...
fs:
  - name: Cargo.toml
    role: wires domain + adapter-pg + composition + application + shared (adapter-mem/test-support/contract-gen/cli as dev-deps); sqlx only for the sweeper's advisory lock
    node: false
  - name: src/
