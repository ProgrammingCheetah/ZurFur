...
fs:
  - name: account/
    role: 27 statements: create/find/list, memberships & roles, invitations, alias, handle change + rate audit, soft & hard delete, departure re-homing, ownership transfer
    node: false
  - name: commission/
